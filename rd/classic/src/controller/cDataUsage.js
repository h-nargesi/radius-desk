Ext.define('Rd.controller.cDataUsage', {
    ...
    selectedRecord: null,
    config: {
        urlUsageForRealm            : '/cake4/rd_cake/data-usages/usage_for_realm.json',
        urlClientUsageForRealm      : '/cake4/rd_cake/data-usages/client_usage_for_realm.json',
        username                    : false,
    ...
    openActivityViewer: function(btn){
        ...
        Rd.getApplication().runAction('cActivityMonitor','Index',pnl); 
    },
    //Add ON
